...
//* Array of created elements (created by startNewGame function) taken from the DOM
    const cellsFromDom = document.querySelectorAll ('.cell');
    

//*#################################################################################

//*Array of 16 unique numbers generated by the generateBomb function.
    const bombsBox = [];
...
//*#####################################################################
    ...
    const bombPlaced = document.createElement('div');
    bombPlaced.innerText = 'B',
    .append(bombPlaced);
